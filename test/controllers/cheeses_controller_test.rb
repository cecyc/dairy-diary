...
class CheesesControllerTest < ActionController::TestCase
  ...
  test "should create cheese" do
    assert_difference('Cheese.count') do
      post :create, cheese: { category_id: @cheese.category_id, name: @cheese.name, thoughts: @cheese.thoughts }
    end
  ...
  test "should update cheese" do
    patch :update, id: @cheese, cheese: { category_id: @cheese.category_id, name: @cheese.name, thoughts: @cheese.thoughts }
    assert_redirected_to cheese_path(assigns(:cheese))
  end
